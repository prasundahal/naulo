                        ...
                        <div class="ps-content">
                            <div class="container">
                                <div class="ps-content-box">
                                    ...
                                    <div class="ps-title">Welcome to <b class='text-success'>NauloBazar</b> Foods &
                                        Organic Online.</div>
            ...
            <div class="container">
                ...
                <div class="component__content promotion__carousel">
                    <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="7000"
                        ...
                        <div class="promotion__thumbnail"><a href="index.html"><img
                                    src="assets/img/promotion/promotion_01.jpg" alt></a></div>
                        <div class="promotion__thumbnail"><a href="index.html"><img
                                    src="assets/img/promotion/promotion_02.jpg" alt></a></div>
                        <div class="promotion__thumbnail"><a href="index.html"><img
                                    src="assets/img/promotion/promotion_03.jpg" alt></a></div>
                        <div class="promotion__thumbnail"><a href="index.html"><img
                                    src="assets/img/promotion/promotion_01.jpg" alt></a></div>
                    </div>
                </div>
    ...
    //   alert(countDownDate);
      ...
      if (distance < 0) {
                ...
                <div class="container">
                    ...
                    <div class="component__content">
                        <div class="owl-carousel" data-owl-auto="true" data-owl-loop="false" data-owl-speed="12000"
                                    ...
                                    <div class="ps-product--standard">
                                        <a href="{{ route('product', $product->slug) }}">
                                            <img class="ps-product__thumbnail"
                                                src="{{ $product->thumbnail_img }}" alt="alt" /></a>
                                        ...
                                        <div class="ps-product__footer">
                                            ...
                                            <button class="ps-product__addcart" onclick="addToCart()"><i class="icon-cart" ></i>Add to
                                                cart</button>
                            ...
                            <div class="ps-sell__product">
                                <div class="ps-product--standard"><a href="product_details.html">
                                    <img class="ps-product__thumbnail" src="assets/img/products/01-fresh/01_22a.jpg"
                                            alt="alt" /></a>
                                            <a class="ps-product__expand" href="javascript:void(0);"><i
                                            class="icon-heart"></i></a>
                                            <span class="ps-badge ps-product__new">New
                                    </span>
                                    <div class="ps-product__content">
                                        <p class="ps-product__type"><i class="icon-store"></i>Shannan Yu</p>
                                        <h5><a class="ps-product__name" href="product_details.html">Bar S -Classic Bun
                                                Length Franks</a></h5>
                                        ...
                                        <p class="ps-product-price-block"><span
                                                class="ps-product__price-default">Rs14.99</span>
                                        </p>
                                    </div>
                                    <div class="ps-product__footer">
                                        <div class="def-number-input number-input safari_only">
                                        ...
                                        <button class="ps-product__addcart"><i class="icon-cart"></i>Add to
                                            cart</button>
                        ...
                        <div class="owl-carousel" data-owl-auto="true" data-owl-loop="false" data-owl-speed="15000"
                            ...
                            @foreach ($recommended as $product)
                                <div class="ps-recommendation__product">
                                    <div class="ps-product--standard"><a href=""><img class="ps-product__thumbnail"
                                                src="{{ $product->thumbnail_img }}" alt="alt" /></a>
                                        @if ($product->tags == 'New')
                                            <span class="ps-badge ps-product__new">New
                                            </span>
                                        ...
                                        <div class="ps-product__content">
                                            ...
                                            <p class="ps-product-price-block"><span
                                                    class="ps-product__price-default">Rs{{ $product->price }}</span>
                                            </p>
                                        </div>
                                ...
                                <div class="ps-sell__product">
                                    <div class="ps-product--standard"><a
                                            href="{{ route('product', $product->slug) }}"><img
                                                class="ps-product__thumbnail" src="{{ $product->thumbnail_img }}"
                                                alt="alt" /></a><a class="ps-product__expand" href="javascript:void(0);"><i
                                                class="icon-heart"></i></a><span class="ps-badge ps-product__new">New
                                        </span>
                                        <div class="ps-product__content">
                                            <p class="ps-product__type"><i class="icon-store"></i>shop -
                                                {{ $product->user->name }}</p>
                                            <h5><a class="ps-product__name"
                                                    href="product_details.html">{{ $product->name }}</a></h5>
                                            <p class="ps-product__unit">454g</p>
                                            <div class="ps-product__rating">
                                                <select class="rating-stars">
                                                    <option value="1">1</option>
                                        ...
                                        <div class="ps-product__footer">
                                            ...
                                            <button class="ps-product__addcart"
                                                onclick="showdToCartModal({{ $product->id }})"><i
        ...
        @if (\App\BusinessSetting::where('type', 'classified_product')->first()->value == 1)
            @php
                $customer_products = \App\CustomerProduct::where('status', '1')
                    ->where('published', '1')
                    ->take(10)
                    ->get();
            @endphp
                        ...
                        <div class="row m-0">
                            @foreach ($customer_products as $key => $customer_product)
                                <div class="col-6 col-lg-3"><a
                                        href="{{ route('customer.product', $customer_product->slug) }}"><img
                                            src="{{ asset($customer_product->thumbnail_img) }}"
                                            data-src="{{ asset($customer_product->thumbnail_img) }}"
                                            alt="{{ __($customer_product->name) }}"></a></div>
                            @endforeach
        ...
        <section class="ps-home--block">
            <div class="container">
                <div class="ps-block--promo"><a href="shop-view-grid.html"><img class="desktop-only"
                            src="assets/img/promotion/promo-03.jpg" alt=""></a><a href="shop-view-grid.html"><img
                            class="mobile-only" src="assets/img/promotion/promo-03-mobile.jpg" alt=""></a></div>
            </div>
        </section>
        ...
        <section class="ps-component--register">
            <div class="container">
                ...
                <p>Join other shoppers in your area, and try naulobazar.com today.</p><a class="ps-button"
                    href="index.html">Register An Account</a>
            </div>
        </section>
                                ...
                                <div class="col-12 col-lg-5">
                                    <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true"
                                        ...
                                        <div class="quickview-carousel"><img class="carousel__thumbnail"
                                                src="assets/img/products/01-fresh/01_1a.jpg" alt="alt" /></div>
                                        <div class="quickview-carousel"><img class="carousel__thumbnail"
                                                src="assets/img/products/01-fresh/01_2a.jpg" alt="alt" /></div>
                                        <div class="quickview-carousel"><img class="carousel__thumbnail"
                                                src="assets/img/products/01-fresh/01_4a.jpg" alt="alt" /></div>
                                        <div class="quickview-carousel"><img class="carousel__thumbnail"
                                                src="assets/img/products/01-fresh/01_9a.jpg" alt="alt" /></div>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-7">
                                    <div class="quickview__product">
                                        ...
                                        <div class="product__content">
                                            <div class="product__price"><span class="sale">Rs5.49</span><span
                                                    class="price">Rs6.90</span><span class="off">25%
                                                    Off</span></div>
                                        ...
                                        <div class="product__action">
                                            ...
                                            <button class="btn product__addcart"> <i class="icon-cart"></i>Add to
                                                cart</button>
                                            <button class="btn button-icon icon-md"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="alert__success"><i class="icon-checkmark-circle"></i> "{{$product->name}}" successfully added to you cart. <a href="shopping-cart.html">View cart(3)</a></div>
                            <hr>
                            ...
                            <div class="cart__content">
                                <div class="owl-carousel" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
                                    ...
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product_details.html"><img
                                                    class="ps-product__thumbnail"
                                                    src="assets/img/products/07-beer-winespirits/07_10a.jpg"
                                                    alt="alt" /></a>
                                            <div class="ps-product__content">
                                                <p class="ps-product__type"><i class="icon-store"></i>NauloBazarMart
                                                </p><a href="product_details.html">
                                                ...
                                                <p class="ps-product-price-block"><span
                                                        class="ps-product__sale">Rs8.90</span><span
                                                        class="ps-product__price">Rs9.90</span><span
                                    ...
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product_details.html"><img
                                                    class="ps-product__thumbnail"
                                                    src="assets/img/products/01-fresh/01_16a.jpg" alt="alt" /></a>
                                            <div class="ps-product__content">
                                                ...
                                                <p class="ps-product-price-block"><span
                                                        class="ps-product__price-default">Rs1.99</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product_details.html"><img
                                                    ...
                                                    alt="alt" /></a>
                                            <div class="ps-product__content">
                                                <p class="ps-product__type"><i class="icon-store"></i>Ganesh Farm</p>
                                                <a href="product_details.html">
                                                ...
                                                <p class="ps-product-price-block"><span
                                                        class="ps-product__price-default">Rs4.49</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product_details.html"><img
                                                    class="ps-product__thumbnail"
                                                    src="assets/img/products/01-fresh/01_15a.jpg" alt="alt" /></a>
                                            <div class="ps-product__content">
                                                <p class="ps-product__type"><i class="icon-store"></i>Naulo Mart</p><a
                                                ...
                                                <p class="ps-product-price-block"><span
                                                        class="ps-product__sale">Rs6.99</span><span
                                                        class="ps-product__price">Rs9.90</span><span
                                    ...
                                    <div class="cart-item">
                                        <div class="ps-product--standard"><a href="product_details.html"><img
                                            ...
                                            <div class="ps-product__content">
                                                ...
                                                <p class="ps-product-price-block"><span
                                                        class="ps-product__sale">Rs4.90</span><span
                                                        class="ps-product__price">Rs3.99</span><span
                                                        class="ps-product__off">15% Off</span>
                                                </p>
                                            </div>
                                        </div>
